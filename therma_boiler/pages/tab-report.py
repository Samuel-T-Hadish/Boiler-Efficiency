...
from therma_boiler.project import Project as PRJ
from therma_boiler.project.report import generate_report
from therma_boiler.schemas.page2 import Page2Input, generate_table_record
...
def report_run(n_clicks, data):
    ...
    report_link = html.A(
        ...
        href=f"/therma_boiler/download/{os.path.basename(tmp_path)}",
        target="_blank",
...
@app.server.route("/therma_boiler/download/<filename>")
